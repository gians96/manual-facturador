...
![Interfaz de creación de dominio VendeYA](../devs/despliegue/plataformas/img/crear-dominio-vendeya.jpg)
...
![Descargar VendeYA](../devs/despliegue/plataformas/img/descargar-vendeya.png)
...
![Cargar archivos](../devs/despliegue/plataformas/img/cargar-datos-vendeya.png)

#### 3.2 Carga del Archivo ZIP

1. **Seleccionar** el archivo `.zip` descargado desde su computadora

![Seleccionar Archivo](../devs/despliegue/plataformas/img/seleccionar-archivo-zip.png)
...
![Regreso Carpeta Raíz](../devs/despliegue/plataformas/img/carpeta-raiz-regreso-vendeya.png)
...
![Extraer VendeYA Compilado](../devs/despliegue/plataformas/img/extraer-vendeya-compilado.png)

#### 4.2 Movimiento de Archivos

1. **Ingresar** a la carpeta `compilado` que se creó tras la extracción

![Entrar a la carpeta de compilado](../devs/despliegue/plataformas/img/entrar-carpeta-compilado.png)
...
![Opción seleccionar todo y mover](../devs/despliegue/plataformas/img/opcion-seleccionar-todo-mover.png)

3. **Mover** los archivos a la carpeta raíz:
   - Hacer clic en **"Mover"**
   - En el modal, seleccionar la carpeta raíz del dominio (un nivel arriba: `..`)

![Mover a Raíz los Archivos](../devs/despliegue/plataformas/img/mover-a-raiz-los-archivos.png)
...
![Crear htaccess](../devs/despliegue/plataformas/img/Htaccess-Vendeya.png)

2. **Editar** el archivo y agregar la siguiente configuración:

![Editar htaccess](../devs/despliegue/plataformas/img/Editar_htaccess_Vendeya.png)
...
![Configuración](../devs/despliegue/plataformas/img/Config-VendeYA.png)
