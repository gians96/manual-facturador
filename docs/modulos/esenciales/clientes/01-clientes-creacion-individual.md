...
![Alt text](img/Clientes_Creacion_Individual_01.png)

## Datos de cliente

Posteriormente aparecerá el formulario para llenar los datos del **Nuevo Cliente.**

![Alt text](img/Clientes_Creacion_Individual_02.png)
...
![Alt text](img/Clientes_Creacion_Individual_03.png)
...
![Alt text](img/Clientes_Creacion_Individual_04.png)
